            ...
            public void onClick(View v) {
                ...
                if (coffee > 0) {
                    ...
                    if (crm.isChecked() && chk.isChecked()) {
                        ...
                        Toast.makeText(MainActivity.this, "You have Selected " + String.valueOf(coffee) + "Coffee Chocolate.Your Bill Is: " + String.valueOf(total), Toast.LENGTH_SHORT).show();
                    } else {
